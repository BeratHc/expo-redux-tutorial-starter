  ...
  return (
    <View className="flex-1 items-center justify-center space-y-6">
       ...
       <View className="flex flex-row items-center justify-evenly w-full">
         <TouchableOpacity onPress={increment} className="py-3 px-5  bg-blue-500  rounded-xl flex items-center justify-center">
            <Text className="text-3xl font-bold text-gray-50">+</Text>
         </TouchableOpacity>
         <TouchableOpacity onPress={decrement} className="py-3 px-5  bg-blue-500 rounded-xl flex items-center justify-center">
           <Text className="text-3xl font-bold text-gray-50">-</Text>
         </TouchableOpacity>
       </View>
     </View>
